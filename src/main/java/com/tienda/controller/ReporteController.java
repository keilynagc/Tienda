...
public class ReporteController {
    ...
    @GetMapping("/CatProd")
    public ResponseEntity<Resource> reporteCatProd(@RequestParam String tipo) 
            throws IOException {
        var reporte= "CatProd";
        return reporteService.generaReporte(reporte, null, tipo);
    }
    
    @GetMapping("/ventasfechas")
    public ResponseEntity<Resource> reporteVentasFechas(@RequestParam String tipo) 
            throws IOException {
        var reporte= "ventasfechas";
        return reporteService.generaReporte(reporte, null, tipo);
    }
